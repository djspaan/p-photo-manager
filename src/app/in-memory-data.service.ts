...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const albums = [
        new Album(1, 'Lloret de Mar', 'Vakantie in Lloret', photos[0]),
        new Album(2, 'Alanya', 'Vakantie in Alanya', photos[1]),
        new Album(3, 'Lloret de Mar', 'Vakantie in Lloret', photos[2])
      ]
    ;
    return {albums: albums, photos: [].concat.apply([], photos)};
  }
}
